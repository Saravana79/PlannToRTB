        ...
        public BiddingAgent
{
    ...
    {
        config = AgentConfig();
	cout << "VICKY: New Creative" << endl;
	// VICKY: Jan-30-2014: Configuring the creative to match the params
	...
	config.creatives.push_back(Creative::sampleLB);
		...
		c.providerConfig["adx"]["clickThroughUrl"] = 
                   "http://click.usmc.com";
		c.providerConfig["adx"]["agencyId"] = 59;
  		...
  		//c.providerConfig["adx"]["adgroup_id"]  = "1642";
	...
	*/
		...
		cout << "VICKY: Agent: Augmentation filtering" << endl;
